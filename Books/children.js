function generateChildren(){
    let cardscontainer=document.getElementById("childrenPage");
    let genre= "children";
...
function generateRelated(id){
  ...
  if (bookRand){
      related.innerHTML= bookRand.slice(-5).map(function(x){
          return `
          <div class="card generated-hover col-12 col-md-6 col-lg mt-5 mb-2 mb-lg-5"  id="product${x.id}" type="button" onclick="openFirst(); generatenewModal('${x.id}');"  data-bs-toggle="modal" data-bs-target="#childrenpageModal">        
      <div class="image-div">
          <img src="../${x.cover}" class="card-img-top generated-image-hover"  loading="lazy" alt="book cover">
          <div class="save-div">
              <a href="../Home/login.html" >
...
function generatenewModal(id){
  ...
  function openFirst() {
    var firstModal = document.getElementById('childrenpageModal');
...
function showSecond() {
    var secondModal = document.getElementById('childrenpageModal');
    var newModal = new bootstrap.Modal(secondModal);
    newModal.show();
}
//for sorting my books alphabetically 
...
function sortBooksA(){
    ...
    let sorted = search.sort(function(a,b){
